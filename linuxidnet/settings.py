...
ALLOWED_HOSTS = ['*', '127.0.0.1', 'localhost', 'linux-id.net', 'www.linux-id.net']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'geekwebi_linuxid', # your database name
        'USER': 'geekwebi_linuxid', # your database user
        'PASSWORD': 'bji~ONP-u=^!', # your database user
...
GOOGLE_ANALYTICS_PROPERTY_ID = 'UA-137016559-2'
...
JSON_LD_DEFAULT_TYPE = 'WebPage'
# JSON_LD_DEFAULT_NAME = 'Linux-ID.net'
# JSON_LD_INDENT = 4
